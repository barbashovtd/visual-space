...
dotfile = dotenv.find_dotenv("../.env", raise_error_if_not_found=True)

if not all(dotenv.dotenv_values(dotfile).values()):
...
WSGI_APPLICATION = "visualspace.wsgi.application"
